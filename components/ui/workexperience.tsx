    ...
    <section id="experience" className="py-16 md:py-24 lg:py-32 bg-background">
      <div className="container px-4 md:px-6">
        ...
        >
          ...
          <h2 className="text-2xl font-bold tracking-tight mt-4 sm:text-3xl md:text-4xl">
            Work Experience
          </h2>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute left-1/2 top-0 h-full w-0.5 bg-muted-foreground/20 transform -translate-x-1/2" />
                ...
                <div className="md:hidden space-y-4">
                  ...
                  <ul className="list-disc list-inside text-muted-foreground space-y-2 list-none">
                    {exp.points.map((point, idx) => (
                      <li className="list-none text-sm" key={idx}>{point}</li>
                    ))}
                  </ul>
                </div>

                {/* Desktop Layout */}
                <div className="hidden md:flex md:flex-row md:items-start md:gap-12 relative">
                  {/* Left side */}
