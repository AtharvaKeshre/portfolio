    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section id="home" className="min-h-screen flex items-center justify-center pt-16 relative overflow-hidden bg-black">
          ...
          <div className="container px-4 md:px-6 relative z-10 ">
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              >
                <div className="relative aspect-square overflow-hidden rounded-full border-4 border-white w-[280px] h-[280px] md:w-[500px] md:h-[500px] bg-background/80 backdrop-blur-sm">
                  <Image src="/images/Linked_Picture_1-removebg-preview.png" alt="John Doe" fill className="object-cover" priority />
                </div>
              </motion.div>
            </div>
            <motion.div
        ...
        <section id="about" className="py-20 md:py-32 bg-background">
          <div className="container px-1 md:px-6">
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:gap-8">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: 0.4 }}
                viewport={{ once: true, margin: "-100px" }}
                className="relative h-[300px] rounded-lg overflow-hidden flex flex-col items-end"
              >
          ...
          <p className="max-w-[350px] text-muted-foreground md:text-xl ml-auto">
            Here's a brief introduction about my background and what I do.
          </p>
        </div>

        {/* Image */}
        <div className="relative w-full h-[280px] mt-2 mr-12">
          <Image
            src="/lefttarrow.jpg" 
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <p>atharvakeshre@gmail.com</p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Linkedin className="h-5 w-5 text-primary" />
                    <p>linkedin.com/in/atharva-keshre/</p>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Github className="h-5 w-5 text-primary" />
                    <p>github.com/AtharvaKeshre</p>
                  </div>
                </div>
                <div className="space-y-4">
